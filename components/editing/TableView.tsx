                                    ...
                                    <td className="p-4 whitespace-nowrap">
                                        <div className="flex items-center space-x-2">
                                            {job.statusId === reviewStatusId && (
                                                <>
                                                    <button onClick={async () => await onNotifyClient(job.id)} className="p-1 text-slate-400 hover:text-green-400" title="Notify Client for Review via WhatsApp">
                                                        <WhatsAppIcon />
                                                    </button>
                                                    <button onClick={async () => await onRequestRevision(job)} className="p-1 text-slate-400 hover:text-purple-400" title="Request Revision">
